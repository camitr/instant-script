...
# tshark to capture the file 
   	tshark -i eth0 -a duration:5 host $ServerIp -w CapFileTest.pcap
...
# Generate Average Packet size
	awk '{avgPckt=$1/295} {print avgPckt}' TotalClientPacket.csv>AvgPacketSec.csv
...
# For Download Bandwidth	
	...
	awk '{avgPckt=$1/295} {print avgPckt}' TotalClientPacketDwn.csv>AvgPacketSecDwn.csv
