...
# tshark to capture the file 
   	tshark -i eth0 -a duration:120  host $ServerIp -w CapFileTest.pcap
...
# Generate Average Packet size
	awk '{avgPckt=$1/120} {print avgPckt}' TotalClientPacket.csv>AvgPacketSec.csv
# Generate Upload bandwidth of client
  	cat AvgPacketSize.csv|awk '{n=$1;getline<"AvgPacketSec.csv";print n*$1}'>BwdthKbps.csv
# For Download Bandwidth	
	...
	awk '{avgPckt=$1/120} {print avgPckt}' TotalClientPacketDown.csv>AvgPacketSecDown.csv
	cat AvgPacketSizeDown.csv|awk '{n=$1;getline<"AvgPacketSecDown.csv";print n*$1}'>BwdthKbpsDown.csv
